...
# This script gives patients ARDS of varying severity and treats them with a nasal cannula

# Arguments: patient - name of patient, severity_level - level of ARDS severity


def ARDS_nasal_cannula(patient, severity_level):
    # Initialize the pulse engine, tell pulse where to send the log file, and also show the log on the console
    pulse = PulseEngine()
    pulse.set_log_filename("./test_results/XCOR/ARDS_nasal_cannula_{}_{}.log".format(patient, severity_level))
    ...
    data_mgr.set_results_filename("./test_results/XCOR/ARDS_nasal_cannula_{}_{}.csv".format(patient, severity_level))
